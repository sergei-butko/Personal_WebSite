 ...
 * this is absent on everything the sync captures, and is filled in by hand:
 * either through the `Name a bottle` workflow, or with `npm run content:pull` /
 * `content:push` like alt text on a photo. A model used to propose it too;
 * that was removed on 2026-09-05.
 *
